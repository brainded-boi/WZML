...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = getCommand('MIRROR_COMMAND', f'm{CMD_INDEX}')
        self.UnzipMirrorCommand = getCommand('UNZIP_COMMAND', f'um{CMD_INDEX}')
        self.ZipMirrorCommand = getCommand('ZIP_COMMAND', f'zm{CMD_INDEX}')
        self.CancelMirror = getCommand('CANCEL_COMMAND', f'cm{CMD_INDEX}')
        self.CancelAllCommand = getCommand('CANCEL_ALL_COMMAND', f'ca{CMD_INDEX}')
        ...
        self.StatusCommand = getCommand('STATUS_COMMAND', f's{CMD_INDEX}')
        self.AuthorizedUsersCommand = getCommand('USERS_COMMAND', f'users{CMD_INDEX}')
        self.AuthorizeCommand = getCommand('AUTH_COMMAND', f'a{CMD_INDEX}')
        self.UnAuthorizeCommand = getCommand('UNAUTH_COMMAND', f'ua{CMD_INDEX}')
        ...
        self.PingCommand = getCommand('PING_COMMAND', f'p{CMD_INDEX}')
        self.RestartCommand =  getCommand('RESTART_COMMAND', f'r{CMD_INDEX}')
        ...
        self.SpeedCommand = getCommand('SPEEDTEST_COMMAND', f'st{CMD_INDEX}')
        self.CloneCommand = getCommand('CLONE_COMMAND', f'c{CMD_INDEX}')
        self.CountCommand = getCommand('COUNT_COMMAND', f'cnt{CMD_INDEX}')
        self.WatchCommand =  getCommand('WATCH_COMMAND', f'w{CMD_INDEX}')
        self.ZipWatchCommand = getCommand('ZIPWATCH_COMMAND', f'zw{CMD_INDEX}')
        self.QbMirrorCommand = getCommand('QBMIRROR_COMMAND', f'qbm{CMD_INDEX}')
        self.QbUnzipMirrorCommand = getCommand('QBUNZIP_COMMAND', f'qbum{CMD_INDEX}')
        self.QbZipMirrorCommand = getCommand('QBZIP_COMMAND', f'qbzm{CMD_INDEX}')
        self.DeleteCommand = getCommand('DELETE_COMMAND', f'del{CMD_INDEX}')
        self.ShellCommand = getCommand('SHELL_COMMAND', f'sh{CMD_INDEX}')
        ...
        self.LeechCommand = getCommand('LEECH_COMMAND', f'l{CMD_INDEX}')
        self.UnzipLeechCommand = getCommand('UNZIPLEECH_COMMAND', f'ul{CMD_INDEX}')
        self.ZipLeechCommand = getCommand('ZIPLEECH_COMMAND', f'zl{CMD_INDEX}')
        self.QbLeechCommand = getCommand('QBLEECH_COMMAND', f'qbl{CMD_INDEX}')
        self.QbUnzipLeechCommand = getCommand('QBZIPLEECH_COMMAND', f'qbul{CMD_INDEX}')
        self.QbZipLeechCommand = getCommand('QBUNZIPLEECH_COMMAND', f'qbzl{CMD_INDEX}')
        self.LeechWatchCommand = getCommand('LEECHWATCH_COMMAND',  f'lw{CMD_INDEX}')
        self.MediaInfoCommand = getCommand('MEDIAINFO_COMMAND', f'info{CMD_INDEX}')
        self.HashCommand = getCommand('HASH_COMMAND', f'hash{CMD_INDEX}')
        self.LeechZipWatchCommand = getCommand('LEECHZIPWATCH_COMMAND', f'lzw{CMD_INDEX}')
        ...
        self.EvalCommand = f'e{CMD_INDEX}'
